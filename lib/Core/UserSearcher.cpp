...
cl::list<Searcher::CoreSearchType> CoreSearch(
    ...
    cl::values(
        ...
        clEnumValN(Searcher::PatchPriority, "patch-priority", "use patch priority (klee-compare)")),
    cl::cat(SearchCat));
...
Searcher *getNewSearcher(Searcher::CoreSearchType type, RNG &rng, PTree &processTree, Executor *exec) {
  ...
  switch (type) {
    ...
    case Searcher::PatchPriority: searcher = new PatchPriority(exec); break;
  }
